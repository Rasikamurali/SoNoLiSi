...
Output: figures/robustness/prompt_variants/
"""
...
RESULTS_DIR = "/data3/rasimura/social-norm-evo/results/robustness/prompt_variants/openai"
OUT_DIR     = "/data3/rasimura/social-norm-evo/figures/robustness/prompt_variants"
...
VARIANT_COLORS  = {"standard": "#1f77b4", "minimal": "#e377c2", "tendency_free": "#2ca02c"}
VARIANT_LABELS  = {"standard": "Standard", "minimal": "Minimal", "tendency_free": "Tendency-Free"}
...
def ols_variant_effect(df_agent):
    ...
    for cond in CONDITIONS:
        ...
        try:
            ...
            for term in ["C(variant, Treatment('standard'))[T.minimal]",
                         "C(variant, Treatment('standard'))[T.tendency_free]"]:
                label = "minimal" if "minimal" in term else "tendency_free"
